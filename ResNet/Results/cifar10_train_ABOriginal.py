...
class Train(object):
    ...
    def train(self):
        ...
        # print("*******FINAL TEST MODEL C********")
        # C_test = self.test([8000,32,32,3], C, "C")

        print("*******FINAL TEST MODEL A********")
        with tf.variable_scope("A"):
            logits = A.inference(self.image_placeholder, FLAGS.num_residual_blocks, reuse=False)
        ...
        print("*******FINAL TEST MODEL B********")
        with tf.variable_scope("B"):
            logits = B.inference(self.image_placeholder, FLAGS.num_residual_blocks, reuse=False)
        ...
        print("*******FINAL TEST MODEL H********")
        with tf.variable_scope("H"):
            logits = H.inference(self.image_placeholder, FLAGS.num_residual_blocks, reuse=False)
