...
from mlengine.trainer.task import load_mnist_data  # import from mlengine/trainer/task.py
from mlengine.trainer.task import load_dataset     # import from mlengine/trainer/task.py
